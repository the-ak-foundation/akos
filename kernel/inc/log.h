...
#if (AKOS_CFG_USE_LOG != 0u) && !defined(AKOS_CFG_USER_PRINT)
#error "AKOS_CFG_USER_PRINT(...) must be defined when AKOS_CFG_USE_LOG is enabled"
#endif
