################################################################################
# @file    board.mk
# @brief   Build configuration for the STM32F103C8T6 board.
#
# @author  BUUPQ
...
MCU := STM32F103C8T6
ARCH := cortex-m3
OS_CFG_SYSTICK_CLOCK_HZ ?= 72000000u
OS_CFG_USE_LOG ?= 0u
...
CPPFLAGS += \
	...
	-DHSE_VALUE=8000000u \
	-DHSI_VALUE=8000000u \
	-DAKOS_PORT_DEVICE_HEADER=\"stm32f1xx.h\"
VPATH += $(BOARD_DIR) $(DEVICE_DIR)/src
SOURCES += \
	$(BOARD_DIR)/bsp.c \
	$(DEVICE_DIR)/src/system_stm32f1xx.c \
	$(DEVICE_DIR)/src/startup_stm32f103xb.s
