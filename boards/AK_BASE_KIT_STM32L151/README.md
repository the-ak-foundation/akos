# AK Base Kit STM32L151 application board

This target builds AKOS as an application image for the AK Base Kit
STM32L151CBT6. It has a board-specific BSP and reuses the CMSIS and startup
support from `boards/STM32L151CBT6` while reserving the bootloader and BSF
regions.
...
|---|---|---|
| `0x08000000` | Boot | [AK Base Kit STM32L151 boot image](https://github.com/ak-embedded-software/ak-base-kit-stm32l151/blob/main/hardware/bin/ak-base-kit-stm32l151-boot.bin) |
| `0x08002000` | BSF | Data shared between Boot and Application |
| `0x08003000` | Application | [AK Base Kit STM32L151 application image](https://github.com/ak-embedded-software/ak-base-kit-stm32l151/blob/main/hardware/bin/ak-base-kit-stm32l151-application.bin) |
...
These assignments match the upstream AK Base Kit
